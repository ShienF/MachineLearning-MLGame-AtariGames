"""
The main script of the machine learning process referenced by the seniors.
"""
import random
...
class MLPlay:
    ...
    def update(self, scene_info):
        ...
        if not self.ball_served:
            self.ball_served = True # 判斷發球
            self.previous_ball = scene_info["ball"]
            command = "SERVE_TO_RIGHT" #右邊發球
            ...
            if scene_info["platform"][0]+20 + 5 < self.pred:
                ...
                command = random.choice(("MOVE_RIGHT","MOVE_LEFT","NONE")) #隨機製造切球
